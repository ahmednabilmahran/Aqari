...
class SizedX {
  ...
  /// Represents a [SizedBox] with a height of 4.5% of the screen height.
  static Widget get h4p5 => SizedBox(height: 4.5.h);
  ...
  /// Represents a [SizedBox] with a height of 10% of the screen height.
  static Widget get h10 => SizedBox(height: 10.h);

  /// Represents a [SizedBox] with a height of 11% of the screen height.
  static Widget get h11 => SizedBox(height: 11.h);

  /// Represents a [SizedBox] with a height of 12% of the screen height.
  static Widget get h12 => SizedBox(height: 12.h);

  /// Represents a [SizedBox] with a height of 13% of the screen height.
  static Widget get h13 => SizedBox(height: 13.h);

  /// Represents a [SizedBox] with a height of 14% of the screen height.
  static Widget get h14 => SizedBox(height: 14.h);

  /// Represents a [SizedBox] with a height of 15% of the screen height.
  static Widget get h15 => SizedBox(height: 15.h);
  ...
  /// Represents a [SizedBox] with a height of 22% of the screen height.
  static Widget get h22 => SizedBox(height: 22.h);

  /// Represents a [SizedBox] with a height of 23% of the screen height.
  static Widget get h23 => SizedBox(height: 23.h);

  /// Represents a [SizedBox] with a height of 24% of the screen height.
  ...
  /// Represents a [SizedBox] with a height of 30% of the screen height.
  static Widget get h30 => SizedBox(height: 30.h);

  // Width-based SizedBox widgets

  /// Represents a [SizedBox] with a width of 1% of the screen width.
  static Widget get w0p5 => SizedBox(width: 0.5.w);
